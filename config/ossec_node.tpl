...
<ossec_config>
  ...
  <syscheck>
    ...
    <directories>/hostfs/etc,/hostfs/usr/bin,/hostfs/usr/sbin</directories>
    <directories>/hostfs/bin,/hostfs/sbin,/hostfs/boot</directories>
    ...
    <nodiff>/hostfs/etc/ssl/private.key</nodiff>
...
<ossec_config>
  <localfile>
    ...
    <location>/hostfs/var/ossec/logs/active-responses.log</location>
  </localfile>
